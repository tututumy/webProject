...
(function(){function a(d,a){var e=d.x-a.x;d=d.y-a.y;a=Math.sqrt(e*e+d*d);return 0<d?Math.acos(e/a):2*Math.PI-Math.acos(e/a)}function b(d,a){var e=d.x-a.x;d=d.y-a.y;a=Math.sqrt(e*e+d*d);e=0<d?Math.acos(e/a)+Math.PI/2:2*Math.PI-Math.acos(e/a)+Math.PI/2;e>2*Math.PI&&(e-=2*Math.PI);return e%(2*Math.PI)}var c={};window.f=c;c.a=function(a,e){this.x=a;this.y=e};c.a.prototype={sub:function(a){return new c.a(this.x-a.x,this.y-a.y)},add:function(a){return new c.a(this.x+a.x,this.y+a.y)},length:function(){return Math.sqrt(this.x*
this.x+this.y*this.y)},normalize:function(a){var d=this.length();this.x=this.x*a/d;this.y=this.y*a/d},toString:function(){return"["+this.x+","+this.y+"]"},xa:function(a){return 1E-6>Math.abs(a.x-this.x)&&1E-6>Math.abs(a.y-this.y)?!0:!1},clone:function(){return new c.a(this.x,this.y)},set:function(a){this.x=a.x;this.y=a.y}};c.a.f=function(a,e,b){return new c.a(a.x*b+e.x*(1-b),a.y*b+e.y*(1-b))};c.a.g=function(a,e){return Math.sqrt((e.x-a.x)*(e.x-a.x)+(e.y-a.y)*(e.y-a.y))};c.ga=function(a,e,c,b,g){this.U=
a;this.V=e;this.h=c;this.i=b;this.end=g};c.P=function(){this.l=-1;this.G=10;this.W=2;this.wa=this.va=this.J=.5};c.D=function(a,e){this.H=new c.a(a,e);this.j=new c.a(a,e);this.u=new c.a(a,e)};c.F=function(a,e,c,b,g,k){this.w=a;this.A=e;this.B=c;this.d=b;this.e=g;this.M=k};c.F.prototype={ya:function(){this.w=1;this.A=this.e=this.B=0;this.d=1;this.M=0},rotate:function(a){var d=Math.cos(a);a=Math.sin(a);return new c.F(d,a,-a,d,0,0)},multiply:function(a,e){return new c.F(a.w*e.w+a.B*e.A,a.A*e.w+a.d*e.A,
a.w*e.B+a.B*e.d,a.A*e.B+a.d*e.d,a.w*e.e+a.B*e.M+a.e,a.A*e.e+a.d*e.M+a.M)},ea:function(a){return new c.a(this.w*a.x+this.B*a.y+this.e,this.A*a.x+this.d*a.y+this.M)}};c.c=function(){};c.c.s=function(a,e,b,h){e=(e.y-a.y)/(e.x-a.x);h=(h.y-b.y)/(h.x-b.x);if(e==h)return null;if(isFinite(e)){if(isFinite(h)){var d=a.y-e*a.x;b=b.y-h*b.x;a=(d-b)/(h-e)}else d=a.y-e*a.x,a=b.x;b=e*a+d}else a=a.x,b=b.y-h*b.x,b=h*a+b;return new c.a(a,b)};c.c.g=function(a,e,c){c=c.sub(e);a=a.sub(e);return 0<c.x*a.y-c.y*a.x?!0:!1};
c.c.da=function(a,e,b,h,g,k){k=Math.sqrt(Math.max(Math.max(c.a.g(e,b),c.a.g(e,h)),c.a.g(b,g)))*(k||1);30>k&&(k=30);for(var d,f,p=0;1>=p;p+=1/k)d=Math.pow(p,3)*(b.x+3*(h.x-g.x)-e.x)+3*Math.pow(p,2)*(e.x-2*h.x+g.x)+3*p*(h.x-e.x)+e.x,f=Math.pow(p,3)*(b.y+3*(h.y-g.y)-e.y)+3*Math.pow(p,2)*(e.y-2*h.y+g.y)+3*p*(h.y-e.y)+e.y,a.push(new c.a(d,f))};c.c.v=function(a,e,b,h,g){for(var d,f=Math.sqrt(Math.max(Math.max(c.a.g(e,b),c.a.g(e,h)),c.a.g(b,h)))*(g||1),m=0;1>=m;m+=1/f)g=(1-m)*(1-m)*e.x+2*m*(1-m)*h.x+m*m*
b.x,d=(1-m)*(1-m)*e.y+2*m*(1-m)*h.y+m*m*b.y,a.push(new c.a(g,d));a.push(new c.a(b.x,b.y))};c.c.Wa=function(a,e,b){var d=b.sub(e);d=a.add(new c.a(-d.y,d.x));e=c.a.f(e,b,.5).sub(c.c.s(e,b,a,d));return a.add(e).add(e)};c.c.I=function(a,e,b){var d=c.a.g(a,e),f=c.a.g(e,b);a=b.sub(a);a.normalize(1);b=new c.D(e.x,e.y);b.u.x=e.x-a.x*d*.3;b.u.y=e.y-a.y*d*.3;b.j.x=e.x+a.x*f*.3;b.j.y=e.y+a.y*f*.3;return b};c.c.O=function(a){for(var d=0,b=a.length,h=0;h<b-1;h++)d+=c.a.g(a[h],a[h+1]);return d};c.c.Va=function(a,
e){var d=a.length;if(0>e)return a[0];if(1<e)return a[d-1];e*=c.c.O(a);for(var b=0,g,k=0;k<d-1;k++){var l=c.a.g(a[k],a[k+1]);b+=l;if(b>=e){g=c.a.f(a[k],a[k+1],(b-e)/l);break}}return g};c.c.C=function(a,e,b,h,g){var d=d||"JointStyle.MITER",f=f||Number.NaN,m=a.length;if(!(2>m))for(var p=c.c.O(a),n=0,q,r=0;r<m;r++)0==r?(q=c.c.ca(a[0],a[1],h),e.push(q.pop()),b.push(q.pop())):r==a.length-1?(q=c.c.ca(a[a.length-1],a[a.length-2],g),b.push(q.pop()),e.push(q.pop())):(n+=c.a.g(a[r],a[r-1]),q=c.c.Ba(a[r-1],a[r],
a[r+1],h-n/p*(h-g),d,f),e.push(q.pop()),b.push(q.pop()))};c.c.Ba=function(a,e,b,h,g,k){var d=a.sub(e),f=b.sub(e);d.normalize(1);f.normalize(1);f=d.add(f);f.normalize(1);if(.001>Math.abs(f.x)&&.001>Math.abs(f.y))return c.c.ca(e,b,h);"JointStyle.MITER"==g?(b=d.x*f.x+d.y*f.y,h/=Math.sqrt(1-b*b),!isNaN(k)&&h>k?f.normalize(k):f.normalize(h)):"JointStyle.ROUND"==g&&f.normalize(h);k=e.add(f);h=[];c.c.g(k,a,e)?(h.push(k),h.push(e.sub(f))):(h.push(e.sub(f)),h.push(k));return h};c.c.ca=function(a,e,b){e=e.sub(a);
e=new c.a(e.y,-e.x);e.normalize(b);b=a.add(e);a=a.sub(e);e=[];e.push(a);e.push(b);return e};c.c.o=function(a,e){var d=[];if(2>a.length)return d;if(2==a.length)return d.push(a[0]),d.push(a[1]),d;a=this.Fa(a,e);for(e=0;e<a.length-1;e++){var c=a[e],b=a[e+1];this.da(d,c.H,b.H,c.j,b.u,1)}return d};c.c.Fa=function(a,e){var d=[],b=a.length;if(e){for(e=0;e<b;e++)0==e?d.push(c.c.I(a[b-1],a[e],a[e+1])):e==b-1?d.push(c.c.I(a[e-1],a[e],a[0])):d.push(c.c.I(a[e-1],a[e],a[e+1]));d.push(c.c.I(a[b-1],a[0],a[1]))}else for(e=
0;e<b;e++)0==e||e==b-1?d.push(new c.D(a[e].x,a[e].y)):d.push(c.c.I(a[e-1],a[e],a[e+1]));return d};c.c.X=function(a,e,b){if(0>(a.x-e.x)*(b.x-e.x)+(a.y-e.y)*(b.y-e.y))var d=c.a.g(a,e);else if(0>(a.x-b.x)*(e.x-b.x)+(a.y-b.y)*(e.y-b.y))d=c.a.g(a,b);else{var f=a.sub(e),k=a.sub(b);f=Math.abs(f.x*k.y-f.y*k.x);b=c.a.g(e,b);0==b?d=c.a.g(a,e):d=f/b}return d};c.c.Sa=function(a){for(var d=[],b=a.length,h=0;h<b-1;h++){var g=a[h],k=a[h+1];c.c.da(d,g.H,k.H,g.u,k.j,3)}c.c.da(d,a[b-1].H,a[0].H,a[b-1].u,a[0].j,3);
return d};c.b=function(){};c.b.o=function(a,e){a=c.c.o(a,e);e=[];for(var d=0;d<a.length;d++){var b=a[d];e.push([b.x,b.y])}return e};c.b.ra=function(a,e,b){a=c.b.za(a,e,b);a=c.b.Ca(a[2],a[0],a[1]);a=c.c.Sa(a);e=[];for(b=0;b<a.length;b++){var d=a[b];e.push([d.x,d.y])}return e};c.b.za=function(a,e,b){var d=c.a.g(a,e),f=c.a.g(a,b),k=Math.max(d,c.a.g(e,b),f);return k==d?c.b.Y(b,a,e):k==f?c.b.Y(e,a,b):c.b.Y(a,e,b)};c.b.Y=function(a,e,b){var d=b.sub(e);d=new c.a(d.y,-d.x);var f=c.c.X(a,e,b);d.normalize(f);
f=c.a.f(e,b,.5);var k=[];c.c.g(a,e,b)?(k.push(b),k.push(e),k.push(f.sub(d))):(k.push(e),k.push(b),k.push(f.add(d)));k.push(a);return k};c.b.Ca=function(a,e,b){var d=[],f=c.a.g(e,b),k=c.a.f(e,b,.5),l=b.sub(e),m=new c.a(l.y,-l.x),p=c.c.X(a,e,b);m.normalize(f/4);var n=new c.F;n.ya();n=n.rotate(-Math.PI/8);var q=n.ea(m);n=new c.D(e.x,e.y);n.j=new c.a(e.sub(q).x,e.sub(q).y);n.u=new c.a(e.add(q).x,e.add(q).y);d.push(n);l.normalize(f/4);n=new c.D(a.x,a.y);n.j=new c.a(a.sub(l).x,a.sub(l).y);n.u=new c.a(a.add(l).x,
a.add(l).y);d.push(n);m.normalize(f/4);n=new c.F;n.ya();n=n.rotate(Math.PI/8);q=n.ea(m);n=new c.D(b.x,b.y);n.j=new c.a(b.add(q).x,b.add(q).y);n.u=new c.a(b.sub(q).x,b.sub(q).y);d.push(n);m.normalize(Math.sqrt(p));a=k.sub(m);l.normalize(f/4);n=new c.D(a.x,a.y);n.j=new c.a(a.add(l).x,a.add(l).y);n.u=new c.a(a.sub(l).x,a.sub(l).y);d.push(n);return d};c.b.$=function(a,e,b,h,g){a=e.sub(a);b*=a.length();b>h&&0<h?a.normalize(h):a.normalize(b);h=e.sub(a);return c.b.ja(h,e,g)};c.b.S=function(a,e,b){var d=
e.sub(a);b=b?new c.a(d.y,-d.x):new c.a(-d.y,d.x);a=c.a.f(a,e,.5);d.length();b.x/=8;b.y/=8;return a.add(b)};c.b.Z=function(a,e,b,h,g){if(!e.xa(b)){g=g||.5;var d=b.sub(e),f=-1!=h.l?h.l/2:d.length()/2;h.W=f/2;d=new c.a(d.y,-d.x);d.normalize(h.W*g);var m=e.add(d),p=e.sub(d),n=b.add(d),q=b.sub(d);d.normalize(f);g=e.add(d);var r=e.sub(d),v=c.a.f(b,e,h.J);m=c.c.s(m,n,v,g);p=c.c.s(p,q,v,r);e=c.a.f(b,e,h.va);d=d.clone();d.normalize(f*h.wa);e.add(d);e.sub(d);a.push(m);a.push(g);a.push(b);a.push(r);a.push(p)}};
c.b.aa=function(a,e,b,h,g){e=b.sub(e);h*=e.length();e.normalize(h);h=b.sub(e);c.b.Z(a,h,b,g,.5)};c.b.ja=function(a,e,b){if(a.xa(e))return new c.ga(a,a,a,a,a);var d=e.sub(a),f=-1!=b.l?b.l/2:d.length()/2;b.W=f/2;var k=new c.a(d.y,-d.x);k.normalize(b.W/2);d=a.add(k);var l=a.sub(k),m=e.add(k),p=e.sub(k);k.normalize(f);var n=a.add(k),q=a.sub(k),r=c.a.f(e,a,b.J);m=c.c.s(d,m,r,n);p=c.c.s(l,p,r,q);a=c.a.f(e,a,b.va);k=k.clone();k.normalize(f*b.wa);a.add(k);a.sub(k);return new c.ga(d,l,m,p,e)};c.b.oa=function(a,
e,b,h,g){var d=[],f=c.b.$(a,b,.3,80,g),m=c.b.$(e,h,.3,80,g),p=[],n=[];c.b.aa(p,a,b,.3,g);c.b.aa(n,e,h,.3,g);var q=c.c.g(b,a,e),r=c.c.g(h,a,e);h=c.c.g(f.h,a,e);b=c.c.g(f.i,a,e);g=c.c.g(m.h,a,e);var v=c.c.g(m.i,a,e);if(0==q){var w=f.i,x=f.V,u=c.b.S(a,f.h,!0);c.c.v(d,a,f.h,u,3);d=d.concat(p)}else{w=f.h;x=f.U;u=c.b.S(a,f.i,!1);var B=[];c.c.v(B,a,f.i,u,3);d=d.concat(B);d=d.concat(p.reverse())}u=a.sub(e);1==r?(f=m.i,p=m.V,a=c.b.ta(a,e,w,f,q==r),q=a.add(u),c.b.fa(d,w,x,a,q,f,p,h==b,g==v),d=d.concat(n.reverse()),
u=c.b.S(m.h,e,!1),c.c.v(d,m.h,e,u,3)):(f=m.h,p=m.U,a=c.b.ta(a,e,w,f,q==r),q=a.add(u),c.b.fa(d,w,x,a,q,f,p,h==b,g==v),d=d.concat(n),u=c.b.S(m.i,e,!0),c.c.v(d,m.i,e,u,3));e=[];for(m=0;m<d.length;m++)n=d[m],e.push([n.x,n.y]);return e};c.b.fa=function(a,e,b,h,g,k,l,m,p){b=m?c.c.s(e,b,h,g):b;g=p?c.c.s(k,l,h,g):l;b&&c.c.v(a,e,h,b,1);g&&c.c.v(a,h,k,g,1)};c.b.ta=function(a,e,b,h,g){var d=c.a.f(a,e,.5),f=c.a.f(b,h,.5),m=a.sub(e),p=b.add(m);m=h.add(m);p=c.c.s(p,b,d,f);m=c.c.s(m,h,d,f);var n=c.a.g(d,p),q=c.a.g(d,
m);c.c.g(b,a,e);c.c.g(h,a,e);if(g)return n<q?c.a.f(d,p,.7):c.a.f(d,m,.7);a=c.a.f(d,f,.9);return Math.min(n,q)>c.a.g(d,a)?a:n<q?c.a.f(p,d,.3):c.a.f(m,d,.3)};c.b.R=function(a,e,b,h,g){var d=[],f=e.sub(a);f=new c.a(f.y,-f.x);f.normalize(c.a.g(a,e)*h);h=a.add(f);f=a.sub(f);d.push(h);c.b.Z(d,c.a.f(a,e,.3),e,b,g);d.push(f);a=[];for(e=0;e<d.length;e++)b=d[e],a.push([b.x,b.y]);return a};c.b.T=function(a,e,b,h,g){g|=0;var d=[],f=c.a.f(a,e,.5);if(c.c.g(a,f,b))var m=e,p=a;else m=a,p=e;var n=c.a.f(f,b,.3);f=
c.b.ja(n,b,h);var q=[];c.b.Z(q,n,b,h);n=f.U.add(f.U.sub(f.h));h=f.V.add(f.V.sub(f.i));c.c.v(d,m,f.h,n);d=d.concat(q);m=[];c.c.v(m,f.i,p,h);d=d.concat(m);1==g&&d.push(c.a.f(c.a.f(a,e,.5),b,.8));a=[];for(e=0;e<d.length;e++)b=d[e],a.push([b.x,b.y]);return a};c.b.ma=function(a,e){var d=.07,b=a.length,g=a[b-1],k=c.c.I(a[b-3],a[b-2],g),l=c.b.$(k.j,g,.5,200,e);b=[];c.b.aa(b,k.j,g,.5,e);g=[];e=[];c.c.C(a,g,e,c.c.O(a)*d,c.a.g(l.h,l.i)/2);g[g.length-1]=l.h;e[e.length-1]=l.i;a=c.c.o(g);d=c.c.o(e);b=a.concat(b);
b=b.concat(d.reverse());a=[];for(d=0;d<b.length;d++)l=b[d],a.push([l.x,l.y]);return a};c.b.Ua=function(a,e,b,h){var d=null,f=new c.P;if(2001==a){if(4>e.length)return;d=c.b.oa(e[0],e[1],e[2],e[3],f)}else 2003==a?d=c.b.R(e[0],e[1],f,.125,.5):2004==a?(f.l=.8*c.a.g(e[0],e[1]),f.J=0,d=c.b.R(e[0],e[1],f,.35,.8)):2005==a?d=c.b.T(e[0],e[1],e[2],f):2006==a?d=c.b.T(e[0],e[1],e[2],f):2007==a?d=c.b.ma(e,f):2008==a?d=c.b.o(e,!0):2011==a&&(d=c.b.ra(e[0],e[1],e[2]));if(null!=d){h.beginPath();h.moveTo(d[0].x,d[0].y);
for(a=1;a<d.length;a++)h.lineTo(d[a].x,d[a].y);h.lineTo(d[0].x,d[0].y);h.closePath();h.fillStyle=b.fillColor;h.fill()}return d};c.b.m=function(a,e,f){var d=[];if(isNaN(f.x)||isNaN(f.y)||1>c.c.X(f,a,e))return[a,e];var g=(a.x*a.x-e.x*e.x+a.y*a.y-e.y*e.y)/2,k=(e.x*e.x-f.x*f.x+e.y*e.y-f.y*f.y)/2,l=a.x-e.x,m=e.x-f.x,p=a.y-e.y,n=e.y-f.y;g={x:(g*n-k*p)/(l*n-m*p),y:(g*m-k*l)/(p*m-n*l)};k=c.a.g(a,g);a=b(a,g)-Math.PI/2;l=b(e,g)-Math.PI/2;m=b(f,g)-Math.PI/2;e=Math.min(a,l);f=Math.max(a,l);if(m<e||m>f)a=e,e=
f,f=a+2*Math.PI;for(;e<=f;e+=.1)a=g.x+k*Math.cos(e),l=g.y+k*Math.sin(e),d.push(new c.a(a,l));a=g.x+k*Math.cos(f);l=g.y+k*Math.sin(f);d.push(new c.a(a,l));return d};c.b.ia=function(a,e,b,h){for(var d=[];b<h;b+=.1){var f=a.x+e*Math.cos(b),l=a.y+e*Math.sin(b);d.push(new c.a(f,l))}f=a.x+e*Math.cos(h);l=a.y+e*Math.sin(h);d.push(new c.a(f,l));return d};c.b.ua=function(a,e){for(var d=a.length,b=[],g,k=0;k<d;k++)0==k?(g=c.a.g(a[0],a[1]),b.push(c.a.f(a[0],a[1],1+e/g)),b.push(c.a.f(a[0],a[1],1-e/g))):d-1==
k?(g=c.a.g(a[d-2],a[d-1]),b.push(c.a.f(a[d-2],a[d-1],e/g)),b.push(c.a.f(a[d-2],a[d-1],-e/g))):(b.push(c.a.f(a[k-1],a[k],e/c.a.g(a[k-1],a[k]))),b.push(c.a.f(a[k],a[k+1],1-e/c.a.g(a[k],a[k+1]))));return b};c.b.N=function(a){if(2>a.length)return a;var d=Math.sqrt(c.c.O(a)/a.length),b=[],h=[];c.c.C(a,b,h,d,d);a=c.b.ua(a,d);d=a[0];d.x=b[0].x;d.y=b[0].y;b=[];for(d=0;d<h.length-1;d++){var g=c.b.m(a[2*d],a[2*d+1],h[d]);b=b.concat(g.reverse())}h=[];h.push(b);return h};c.b.ba=function(a,e){if(2>a.length)return a;
e=Math.sqrt(c.c.O(a)/a.length);var d=[];c.c.C(a,[],d,e,e);a=c.b.ua(a,e);e=[];for(var b=0;b<d.length;b++){var g=c.b.m(a[2*b],a[2*b+1],d[b]);g=g.reverse();e.push(g)}return e};c.b.Qa=function(a){if(2>a.length)return a;var d=[],b=[],h=a[0],g=a[1],k=30/(30+Math.sqrt((h.x-g.x)*(h.x-g.x)+(h.y-g.y)*(h.y-g.y))),l=(g.x-h.x*k)/(1-k),m=(g.y-h.y*k)/(1-k),p=new c.a((h.x-g.x*k)/(1-k),(h.y-g.y*k)/(1-k));k=h.sub(p);k=new c.a(k.y,-k.x);k.normalize(20);p=c.a.f(h,p,.5);h=p.add(k);k=p.sub(k);d.push(h);b.push(k);c.c.C(a,
d,b,10,10);l=new c.a(l,m);k=g.sub(l);a=new c.a(k.y,-k.x);a.normalize(20);l=c.a.f(g,l,.5);g=l.sub(a);a=l.add(a);d.push(g);b.push(a);g=[];g.push(d);g.push(b);return g};c.b.f=function(a,e){var d=new c.P;d.G=6;var b=e.sub(a),g=-1!=d.l?d.l/2:d.G/2,k=new c.a(b.y,-b.x);b=b.clone();b.normalize(b.length()-d.G);b=b.add(a);k=k.clone();k.normalize(g);g=b.add(k);k=b.sub(k);d=c.a.f(e,b,d.J);b=[];b.push(a);b.push(d);b.push(g);b.push(e);b.push(k);b.push(d);return b};c.b.sa=function(a,e,b){var d=new c.P;d.G=6;var f=
e.sub(a),k=-1!=d.l?d.l/2:d.G/2,l=new c.a(f.y,-f.x);f=f.clone();f.normalize(f.length()-d.G);f=f.add(a);l=l.clone();l.normalize(k);k=f.add(l);l=f.sub(l);d=c.a.f(e,f,d.J);f=[];f.push(b);f.push(a);f.push(d);f.push(k);f.push(e);f.push(l);f.push(d);return f};c.b.K=function(a,e){var d=[],b=new c.a(0,0);b.x=a.x-e/2;b.y=a.y+.2*e;var g=new c.a(0,0);g.x=a.x-e/2;g.y=b.y-e/3;var k=new c.a(0,0);k.x=a.x-e/2;k.y=b.y+e/3;var l=[];l.push(new c.a(a.x,a.y));l.push(new c.a(a.x+e,a.y));d.push(l);l=[];l.push(g);l.push(k);
d.push(l);g=new c.a(0,0);g.x=a.x+e/2;g.y=a.y+.2*e;k=new c.a(0,0);k.x=a.x+e/2;k.y=g.y-e/3;l=new c.a(0,0);l.x=a.x+e/2;l.y=g.y+e/3;var m=[];m.push(k);m.push(l);d.push(m);k=[];k.push(b);k.push(g);d.push(k);b=new c.a(0,0);b.x=a.x;b.y=g.y;k=new c.a(0,0);k.x=a.x;k.y=g.y-.8*e;a=c.b.f(b,k);d.push(a);return d};c.b.Aa=function(a,b){var d=[],e=[];e.push(new c.a(a.x,a.y));e.push(new c.a(a.x+b,a.y));d.push(e);e=new c.a(0,0);e.x=a.x-b/2;e.y=a.y+.2*b;var g=new c.a(0,0);g.x=a.x-b/2;g.y=e.y-b/3;var k=new c.a(0,0);
k.x=a.x-b/2;k.y=e.y+b/3;var l=[];l.push(g);l.push(k);d.push(l);g=new c.a(0,0);g.x=a.x+b/2;g.y=a.y+.2*b;l=new c.a(0,0);l.x=a.x+b/2;l.y=g.y-b/3;k=new c.a(0,0);k.x=a.x+b/2;k.y=g.y+b/3;var m=[];m.push(l);m.push(k);d.push(m);l=[];m=new c.a(0,0);m.x=e.x;m.y=a.y+Math.sqrt(3)*b/2;var p=new c.a(0,0);p.x=g.x;p.y=a.y+Math.sqrt(3)*b/2;e=new c.a(0,0);e.x=a.x;e.y=k.y;l.push(m);l.push(e);l.push(p);d.push(l);k=new c.a(0,0);k.x=a.x;k.y=g.y-.8*b;a=c.b.f(e,k);d.push(a);return d};c.b.la=function(a,b){var d=[],e=[];e.push(new c.a(a.x,
a.y));e.push(new c.a(a.x+b,a.y));d.push(e);e=new c.a(0,0);e.x=a.x-b/2;e.y=a.y+.2*b;var g=new c.a(0,0);g.x=a.x-b/2;g.y=e.y-b/3;var k=new c.a(0,0);k.x=a.x-b/2;k.y=e.y+b/3;e=[];e.push(g);e.push(k);d.push(e);e=new c.a(0,0);e.x=a.x+b/2;e.y=a.y+.2*b;var l=new c.a(0,0);l.x=a.x+b/2;l.y=e.y-b/3;var m=new c.a(0,0);m.x=a.x+b/2;m.y=e.y+b/3;var p=[];p.push(l);p.push(m);d.push(p);p=c.a.f(g,k,.66);var n=c.a.f(l,m,.33);l=c.a.f(l,m,.66);m=[];m.push(c.a.f(g,k,.33));m.push(n);d.push(m);g=[];g.push(p);g.push(l);d.push(g);
g=new c.a(0,0);g.x=a.x;g.y=l.y;k=new c.a(0,0);k.x=a.x;k.y=e.y-.8*b;a=c.b.f(g,k);d.push(a);return d};c.b.ka=function(a,b,f){b/=c.a.g(a,f);var d=new c.a(0,0);d.x=(1-b)*a.x+b*f.x;d.y=(1-b)*a.y+b*f.y;return d};c.b.pa=function(a,b){var d=[],e=[];e.push(a);e.push(b);var g=[],k=[],l=b.sub(a);l=new c.a(l.y,-l.x);l.normalize(20);g.push(a.add(l));k.push(a.sub(l));c.c.C(e,g,k,10,10);g.push(b.add(l));k.push(b.sub(l));d.push(g);d.push(k);return d};c.b.qa=function(a,b){var d=[],e=[];e.push(a);e.push(b);var g=[],
k=[],l=b.sub(a);l=new c.a(l.y,-l.x);l.normalize(20);g.push(a.add(l));k.push(a.sub(l));c.c.C(e,g,k,5,5);g.push(b.add(l));k.push(b.sub(l));a=c.b.ha(g);k=c.b.ha(k);for(b=0;b<a.length;b++)d.push(a[b]);for(b=0;b<k.length;b++)d.push(k[b]);return d};c.b.ha=function(a){var d=[],b=[];b.push(a[0]);b.push(a[1]);var h=a[1],g=a[2];b.push(c.a.f(h,g,.9));d.push(b);b=[];b.push(c.a.f(h,g,.8));b.push(c.a.f(h,g,.2));d.push(b);b=[];b.push(c.a.f(h,g,.1));b.push(g);b.push(a[3]);d.push(b);return d};c.b.Da=function(a,b){if(5>
...
for(b=0;b<e.length;b++)a.push(e[b]);return a};c.b.Ha=function(a,b){if(4>a.length)return a;b=c.b.K(a[0],b);var d=c.b.f(a[1],a[2]);a=c.b.f(a[1],a[3]);b.push(d);b.push(a);return b};c.b.L=function(a,b,f){var d=[];d.push(a);d.push(b);a=[];c.c.C(d,[],a,f,f);return a};c.b.Ia=function(a,b){if(2>a.length)return a;var d=a[0].x,e=a[0].y,g=a[1].x,k=a[1].y;a[0].x>a[1].x&&(d=a[1].x,g=a[0].x);a[0].y>a[1].y&&(e=a[1].y,k=a[0].y);a=new c.a(d,e);g=new c.a(g,k);k=new c.a(g.x,a.y);d=new c.a(a.x,g.y);e=c.b.K(a,b);for(var l=
c.b.K(k,b),m=c.b.la(g,b),p=c.b.la(d,b),n=[],q=0;q<e.length;q++)n.push(e[q]),n.push(l[q]),n.push(m[q]),n.push(p[q]);for(q=e.length;q<m.length;q++)n.push(m[q]),n.push(p[q]);n.push(c.b.L(a,d,b));n.push(c.b.L(d,g,b));n.push(c.b.L(g,k,b));n.push(c.b.L(k,a,b));return n};c.b.Ja=function(a,b){if(2>a.length)return a;for(var d=[],e=0;e<a.length;e++){for(var g=c.b.Aa(a[e],b),k=0;k<g.length;k++)d.push(g[k]);e!=a.length-1?(g=a[e],k=a[e+1]):(g=a[e],k=a[0]);d.push(c.b.L(g,k,b))}return d};c.b.Ka=function(a,b){var d=
a[0].x,e=a[0].y,g=a[1].x,k=a[1].y;a[0].x>a[1].x&&(d=a[1].x,g=a[0].x);a[0].y>a[1].y&&(e=a[1].y,k=a[0].y);a=new c.a(d,e);d=new c.a(g,k);g=new c.a(d.x,a.y);k=new c.a(a.x,d.y);e=[];e.push(a);e.push(k);e.push(d);e.push(g);e.push(a);g=c.b.N(e);k=b[0];b=b[1];a=c.a.f(a,d,.5);d=new c.a(a.x-k/4,a.y-b/2);e=new c.a(a.x-k/2,a.y);var l=new c.a(a.x-k/4,a.y+b/2),m=new c.a(a.x,a.y),p=new c.a(a.x+k/4,a.y-b/2),n=new c.a(a.x+k/2,a.y),q=[];q.push(new c.a(a.x+k/4,a.y+b/2));q.push(n);q.push(p);q.push(m);q.push(l);q.push(e);
q.push(d);k=c.c.o(q,!1);b=k.pop();a=k.pop();b=c.b.f(a,b);for(a=0;a<b.length;a++)k.push(b[a]);g.push(k);return g};c.b.La=function(a,b){var d=a[0].x,e=a[0].y,g=a[1].x,k=a[1].y;a[0].x>a[1].x&&(d=a[1].x,g=a[0].x);a[0].y>a[1].y&&(e=a[1].y,k=a[0].y);a=new c.a(d,e);g=new c.a(g,k);k=new c.a(g.x,a.y);var l=new c.a(a.x,g.y),m=[];m.push(a);m.push(l);m.push(g);m.push(k);m.push(a);a=c.b.N(m);g=b[0];b=b[1];d=new c.a(d+30,e+5);e=new c.a(d.x-b/2,d.y+b/2);k=new c.a(d.x,d.y+b);l=new c.a(k.x-b/2,k.y+b/2);m=[];m.push(d);
m.push(e);m.push(k);a.push(m);k=c.b.f(k,l);a.push(k);d=new c.a(d.x+5,e.y);e=c.b.f(new c.a(d.x+g,d.y),d);a.push(e);e=new c.a(d.x+g/2+10,d.y-b/2);k=new c.a(d.x+g/2+10,d.y+b/2);l=[];l.push(e);l.push(k);a.push(l);g=c.b.m(new c.a(d.x+g/4,e.y),new c.a(d.x+g/4,k.y),new c.a(d.x+g/4+b/2,(k.y+e.y)/2));a.push(g);return a};c.b.Ma=function(a,b){var d=a[0].x,e=a[0].y,g=a[1].x,k=a[1].y;a[0].x>a[1].x&&(d=a[1].x,g=a[0].x);a[0].y>a[1].y&&(e=a[1].y,k=a[0].y);a=new c.a(d,e);d=new c.a(g,k);g=new c.a(d.x,a.y);k=new c.a(a.x,
d.y);e=[];e.push(a);e.push(k);e.push(d);e.push(g);e.push(a);g=c.b.N(e);k=b[0];b=b[1];a=c.a.f(a,d,.5);d=c.b.f(new c.a(a.x,a.y-b/2),new c.a(a.x-k-10,a.y-b/2));g.push(d);d=new c.a(a.x-k/2,a.y);e=[];e.push(new c.a(a.x-k/2,a.y-b));e.push(d);g.push(e);b=c.b.m(new c.a(a.x-3*k/4-b/2,a.y-b),new c.a(a.x-3*k/4-b/2,a.y),new c.a(a.x-3*k/4,a.y-b/2));g.push(b);return g};c.b.na=function(a){a=c.b.m(a[0],a[2],a[1]);a.pop();a.pop();var b=a.pop(),d=a.pop();b=c.b.f(d,b);for(d=0;d<b.length;d++)a.push(b[d]);return a};c.b.Na=
function(a,b){var d=a[0];2==a.length&&(d=c.a.f(a[0],a[1],.5));a=b[0];b=b[1];var e=new c.a(d.x-a/2,d.y),g=new c.a(d.x+a/2,d.y),k=new c.a(d.x,d.y-b/2),l=new c.a(d.x,d.y+b/2);b=[];var m=[];m.push(e);m.push(k);m.push(g);k=c.b.na(m);b.push(k);m[0]=g;m[1]=l;m[2]=e;k=c.b.na(m);b.push(k);e=new c.a(e.x-10,d.y);e=c.b.f(new c.a(e.x-a,d.y),e);b.push(e);g=new c.a(g.x+10,d.y);d=c.b.f(new c.a(g.x+a,d.y),g);b.push(d);return b};c.b.Oa=function(a,b){var d=c.b.ia(a[0],c.a.g(a[0],a[1]),b[0],b[1]);-1==b[2]&&d.push(a[0]);
return d};c.b.Pa=function(b){var d=[];d.push(b[0]);var f=c.a.g(b[0],b[1]),h=a(b[1],b[0]),g=a(b[2],b[0]);g<h&&(g+=2*Math.PI);b=c.b.ia(b[0],f,h,g);return d.concat(b)};c.b.Ta=function(a,b,f){var d=[];b=new c.a(0,-b);var e=new c.F(1,0,0,1,0,0);e.rotate(0);for(var k=0;k<f;k++){var l=e.ea(b);l=l.add(a);d.push(l);e=e.multiply(e,e.rotate(2*Math.PI/f))}return d};c.b.Ra=function(a,b,f){var d=null,e=new c.P;if(2001==a){if(4>b.length)return;d=c.b.oa(b[0],b[1],b[3],b[2],e)}else if(2003==a)d=c.b.R(b[0],b[1],e,
.125,.5);else if(2004==a)e.l=.8*c.a.g(b[0],b[1]),e.J=0,d=c.b.R(b[0],b[1],e,.35,.8);else if(2005==a)d=c.b.T(b[0],b[1],b[2],e,!1);else if(2006==a)d=c.b.T(b[0],b[1],b[2],e,!0);else if(2007==a)d=c.b.ma(b,e);else if(2008==a)d=c.b.o(b,!0);else if(2011==a)d=c.b.ra(b[0],b[1],b[2]);else if(2015==a)d=c.b.o(b,!1);else{if(2031==a)return d=c.b.m(b[0],b[1],b[2]),[d];if(2032==a)d=c.b.N(b);else if(2033==a)d=c.b.ba(b,f);else if(2034==a)d=c.b.Qa(b);else if(2035==a)d=c.b.Da(b,f[0]);else if(2036==a)d=c.b.Ea(b,f[0]);
else if(2037==a)d=c.b.Ga(b,f[0]);else if(2038==a)d=c.b.Ha(b,f[0]);else if(2039==a)d=c.b.Ia(b,f[0]);else if(2040==a)d=c.b.Ja(b,f[0]);else if(2041==a)d=c.b.Ka(b,f);else if(2042==a)d=c.b.La(b,f);else if(2043==a)d=c.b.Ma(b,f);else if(2044==a)d=c.b.Na(b,f);else if(2052==a)d=c.b.N(b);else if(2053==a)d=c.b.ba(b,f);else if(2054==a)d=c.b.ba(b,f);else{if(2055==a||2056==a||2057==a)return d=c.b.m(b[0],b[1],b[2]),[d];if(2060==a)return d=c.b.Oa(b,f),[d];if(2061==a)return d=c.b.Pa(b),[d];if(2100==a||2101==a||2102==
a||2150==a||2151==a||2152==a||2153==a||2154==a)return[b];if(2103==a||2104==a)return a=b.length,f=c.a.g(b[0],b[a-1]),d=c.b.Ta(b[0],f,a+1),[d];if(2105==a)return f=[[b[0].x,b[0].y],[b[0].x,b[1].y],[b[1].x,b[1].y],[b[1].x,b[0].y]],[f];if(2071==a){f=c.b.o(b,!1);b=f.pop();a=f[f.length-1];b=c.b.f(new c.a(a[0],a[1]),new c.a(b[0],b[1]));a=[];for(d=0;d<b.length;d+=1)e=[b[d].x,b[d].y],a.push(e);return[f,a]}if(2072==a||2073==a){f=[];f.push([b[0].x,b[0].y]);f.push([b[1].x,b[1].y]);b=c.b.f(b[0],b[1]);a=[];for(d=
1;d<b.length;d+=1)e=[b[d].x,b[d].y],a.push(e);return[f,a]}}}return d};window.H5JB_getJBArray=function(a,b,f){for(var d=[],e=0;e<b.length;e+=2)d.push(new c.a(b[e],b[e+1]));return c.b.Ra(a,d,f)}})();function pointDistance(a,b){var c=b.x-a.x;a=b.y-a.y;return Math.sqrt(c*c+a*a)}var R=6371E3;function distanceBetween(a,b){var c=Math.PI/180,d=Math.sin((b.lat-a.lat)*c/2),e=Math.sin((b.lng-a.lng)*c/2);a=d*d+Math.cos(a.lat*c)*Math.cos(b.lat*c)*e*e;return 2*R*Math.atan2(Math.sqrt(a),Math.sqrt(1-a))}function computeSegmentHeading(a,b){return(180*Math.atan2(b.y-a.y,b.x-a.x)/Math.PI+450)%360}function asRatioToPathLength(a,b){var c=a.value;return a.isInPixels?c/b:c}
...
60],[180,60],[180,60],[180,60]];null!=this.options.angleArray?(a=this.options.angleArray[0]%360,b=a+this.options.angleArray[1]-this.options.angleArray[0],this._angleArray=2090!=this.options.keyid?[a*Math.PI/180,b*Math.PI/180]:[a,b],360>this.options.angleArray[1]-this.options.angleArray[0]&&(this._angleArray[2]=-1)):(this._angleArray=2090!=this.options.keyid?[0,2*Math.PI]:[0,360],this._angleArray[2]=0);null!=this.options.radius&&(this._radius=this.options.radius)},_initPaths:function(a,b){var c=this;
...
this._symbolClick,this),this._lineLayers[a].off("contextmenu",this._showMenu,this);this._draw()}},_showMenu:function(a){this._items=[];var b;if(this._map.contextmenu){var c=GMap.extend({relatedTarget:this},a);var d=this._map.mouseEventToContainerPoint(a.originalEvent);this.options.contextmenuInheritItems||this._map.contextmenu.hideAllItems();var e=0;for(b=this.options.contextmenuItems.length;e<b;e++)a=this.options.contextmenuItems[e],this._items.push(this._map.contextmenu.insertItem(a,a.index));this._map.once("contextmenu.hide",
this._hideContextMenu,this);this._map.contextmenu.showAt(d,c)}},_hideContextMenu:function(){var a;var b=0;for(a=this._items.length;b<a;b++)this._map.contextmenu.removeItem(this._items[b]);this._items.length=0;this.options.contextmenuInheritItems||this._map.contextmenu.showAllItems()},_symbolClick:function(a){this._map.drawHelper.showEditPage(1,this._keyid,this)},_getFillPattern:function(a){var b=a.fillType,c=new GMap.StripePattern({spaceOpacity:1,angle:60});if("fillByHline"==b)return b=new GMap.PatternPath({d:"M0 4 L8 4  Z",
fill:!0,weight:1,color:a.stroke}),a=new GMap.Pattern({width:8,height:8}),a.addShape(b),a.addTo(this._map),a;if("fillByVline"==b)return c=new GMap.PatternPath({d:"M4 0 L4 8 Z",fill:!0,weight:1,color:a.stroke}),a=new GMap.Pattern({width:8,height:8}),a.addShape(c),a.addTo(this._map),a;if("fillByXieline"==b)return b=new GMap.PatternPath({d:"M0 0 L8 8  Z",fill:!0,weight:1,color:a.stroke}),a=new GMap.Pattern({width:8,height:8}),a.addShape(b),a.addTo(this._map),a;if("fillByAntixieline"==b)return b=new GMap.PatternPath({d:"M0 8 L8 0  Z",
fill:!0,weight:1,color:a.stroke}),a=new GMap.Pattern({width:8,height:8}),a.addShape(b),a.addTo(this._map),a;if("fillByJinline"==b)return b=new GMap.PatternPath({d:"M0 4 L8 4  Z",fill:!0,weight:1,color:a.stroke}),c=new GMap.PatternPath({d:"M4 0 L4 8 Z",fill:!0,weight:1,color:a.stroke}),a=new GMap.Pattern({width:8,height:8}),a.addShape(b),a.addShape(c),a.addTo(this._map),a;c.addTo(this._map);return c},_getPatternLayers:function(){var a=this;this._map.getBounds().pad(.1);var b={color:a._style.stroke,
weight:a._style.strokeWidth,opacity:a._style.outlineOpacity};return this._paths.map(function(c){c=a._getPolyFromPos(a._keyid,c);for(var d=[],e=0;e<c.length;e++)if(2031==a._keyid||2055==a._keyid||2056==a._keyid||2057==a._keyid||2100==a._keyid||2101==a._keyid||2072==a._keyid)if(null==a._style._patterns)d.push(GMap.polyline(c[e],b));else{var f=GMap.polylineSymbol(c[e],{patterns:a._style._patterns});d.push(f)}else if(2071==a._keyid||2015==a._keyid)null==a._style._patterns||0!=e?d.push(GMap.polyline(c[e],
...
2052==a._keyid)d.push(GMap.polyline(c[e],b));else if(2033==a._keyid||2053==a._keyid||2054==a._keyid)d.push(GMap.polyline(c[e],b)),e!=c.length-1&&(f=[],f.push(c[e][c[e].length-1]),f.push(c[e+1][0]),f=GMap.polylineSymbol(f,{patterns:a._style._patterns}),d.push(f));else if(2035==a._keyid||2036==a._keyid||2037==a._keyid||2038==a._keyid)0==e?(f=distanceBetween(c[e][0],c[e][1]),f=GMap.circle(c[e][0],{radius:f,fill:!1,color:a._style.stroke,weight:a._style.strokeWidth,opacity:a._style.outlineOpacity}),d.push(f)):
d.push(GMap.polyline(c[e],b));else if(2039==a._keyid)4>e?(f=distanceBetween(c[e][0],c[e][1]),f=GMap.circle(c[e][0],{radius:f,fill:!1,color:a._style.stroke,weight:a._style.strokeWidth,opacity:a._style.outlineOpacity}),d.push(f)):d.push(GMap.polyline(c[e],b));else if(2040==a._keyid)if(0==e%6)f=distanceBetween(c[e][0],c[e][1]),f=GMap.circle(c[e][0],{radius:f,fill:!1,color:a._style.stroke,weight:a._style.strokeWidth,opacity:a._style.outlineOpacity}),d.push(f);else if(5!=e%6)d.push(GMap.polyline(c[e],
b));else if(null==a._style._patterns)d.push(GMap.polyline(c[e],b));else{f=a._style._patterns;for(var h=0;h<f.length;h++)f[h].symbol.options.pathOptions.color=a._style.stroke;b.patterns=f;f=GMap.polylineSymbol(c[e],b);d.push(f)}else if(2041==a._keyid||2042==a._keyid||2043==a._keyid)0==e?(f=a._createPolygonWithPattern(c[e],a._style),d.push(f)):d.push(GMap.polyline(c[e],b));else if(2044==a._keyid)d.push(GMap.polyline(c[e],{color:a._style._colors[e%2],weight:a._style.strokeWidth,opacity:a._style.outlineOpacity}));
else if(2090==a._keyid||2061==a._keyid||2060==a._keyid||2004==a._keyid||2006==a._keyid||2003==a._keyid||2007==a._keyid||2102==a._keyid||2103==a._keyid||2104==a._keyid||2105==a._keyid)f=a._createPolygonWithPattern(c[e],a._style),d.push(f);return GMap.featureGroup(d)})},_createPolygonWithPattern:function(a,b){var c=this._map.getRenderer(this),d=this._getFillPattern(b);"fillByNone"==b.fillType?a=GMap.polygon(a,{fill:!1,color:b.stroke,weight:b.strokeWidth,opacity:b.outlineOpacity}):"fillByColor"==b.fillType?
(c=b.stroke,null!=b._colors&&(c=b._colors[0]),a=GMap.polygon(a,{fill:!0,color:b.stroke,fillColor:c,weight:b.strokeWidth,opacity:b.outlineOpacity})):a=c._ctx?GMap.polygonFill(a,{color:b.stroke,weight:b.strokeWidth,fillType:b.fillType,bgFillColor:b.stroke,fillOpacity:b.outlineOpacity}):GMap.polygon(a,{color:b.stroke,weight:b.strokeWidth,fillPattern:d,fillOpacity:b.outlineOpacity});return a},_destination:function(a,b,c,d){var e=Math.PI/180,f=6378137*(1-.003352810664/3),h=Math.asin(Math.sin(b*e)*Math.cos(d/
f)+Math.cos(b*e)*Math.sin(d/f)*Math.cos(c*e))/e;return new GMap.LatLng(h,a+Math.atan2(Math.sin(c*e)*Math.sin(d/f)*Math.cos(b*e),Math.cos(d/f)-Math.sin(b*e)*Math.sin(h*e))/e)},_getPolyFromPos:function(a,b){var c=[],d=b.length,e;var f=[];for(e=0;e<d;e++)f[e]=this._map.latLngToLayerPoint(b[e]);d=!1;e=[];var h=[25];if(2031==a||2055==a||2056==a||2057==a||2061==a){if(3<=f.length){for(d=0;3>d;d++)e.push(f[d].x),e.push(f[d].y);d=!0}}else if(2032==a||2033==a||2052==a||2053==a||2054==a||2006==a||2007==a||2104==
a){if(3<=f.length){for(d=0;d<f.length;d++)e.push(f[d].x),e.push(f[d].y);d=!0}}else if(2015==a){if(2<=f.length){f=simplify(f,1,!0);for(d=0;d<f.length;d++)e.push(f[d].x),e.push(f[d].y);d=!0}}else if(2034==a||2060==a||2004==a||2003==a||2100==a||2072==a||2073==a||2105==a||2103==a){if(2<=f.length){for(d=0;2>d;d++)e.push(f[d].x),e.push(f[d].y);d=!0}}else if(2035==a||2036==a||2037==a||2038==a||2039==a||2040==a||2041==a||2042==a||2043==a||2044==a||2101==a||2102==a||2071==a||2150==a||2151==a||2152==a||2153==
a||2154==a){for(d=0;d<f.length;d++)e.push(f[d].x),e.push(f[d].y);d=!0}else if(2090==a){for(c=this._angleArray[0];c<=this._angleArray[1];c+=1)a=this._destination(b[0][1],b[0][0],c,this._radius),e.push(a);-1==this._angleArray[2]&&e.push(new GMap.LatLng(b[0][0],b[0][1]));return[e]}if(1==d){2041==a||2042==a||2043==a||2044==a?(d=this._map.getZoom(),d=this._sizeArray[d],h[0]=d[0],h[1]=d[1]):2060==a&&(h[0]=this._angleArray[0],h[1]=this._angleArray[1],h[2]=this._angleArray[2]);b=H5JB_getJBArray(a,e,h);e=
[];if(2030>a){for(d=0;d<b.length;d++)a=this._map.layerPointToLatLng(b[d]),c.push(a);e.push(c)}else for(d=0;d<b.length;d++){c=[];h=b[d];for(f=0;f<h.length;f++)a=this._map.layerPointToLatLng(h[f]),c.push(a);e.push(c)}return e}return b},_draw:function(){this._lineLayers=this._getPatternLayers();for(var a=0;a<this._lineLayers.length;a++)this._lineLayers[a].on("click",this._symbolClick,this),this._lineLayers[a].on("contextmenu",this._showMenu,this);this.addLayer(GMap.featureGroup(this._lineLayers))},_setStyle:function(a){null!=
a.fillType&&(this._style.fillType=a.fillType);null!=a.outlineColor&&(this._style.stroke=a.outlineColor);null!=a.outlineWidth&&(this._style.strokeWidth=a.outlineWidth);null!=a.opacity&&(this._style.outlineOpacity=a.opacity);null!=a.lineType&&(this._style._patterns="dash"==a.lineType?g_patterns[0]:"point"==a.lineType?g_patterns[1]:"ptline"==a.lineType?g_patterns[2]:null);if(null!=this._style._patterns){a=this._style._patterns;for(var b=0;b<a.length;b++)a[b].symbol.options.pathOptions.color=this._style.stroke,
a[b].symbol.options.pathOptions.weight=this._style.strokeWidth}this.redraw()},changeControlPoints:function(a){for(var b=0;b<this._lineMarkers.length;b++)this._lineMarkers[b].setLatLng(a[b]);this._paths=this._initPaths(a);this._setControlLatLngs(a);this.redraw()}});GMap.polylineJBSymbol=function(a,b){return new GMap.PolylineJBSymbol(a,b)};
...
GMap.PlotUtils.getCurvePoints=function(a,b){for(var c=[GMap.PlotUtils.getLeftMostControlPoint(b)],d=0;d<b.length-2;d++){var e=b[d],f=b[d+1];e=GMap.PlotUtils.getBisectorNormals(a,e,f,b[d+2]);c=c.concat(e)}a=GMap.PlotUtils.getRightMostControlPoint(b);c.push(a);var h=[];for(d=0;d<b.length-1;d++){e=b[d];f=b[d+1];h.push(e);for(a=0;a<GMap.Constants.FITTING_COUNT;a++){var g=GMap.PlotUtils.getCubicValue(a/GMap.Constants.FITTING_COUNT,e,c[2*d],c[2*d+1],f);h.push(g)}h.push(f)}return h};
GMap.PlotUtils.getLeftMostControlPoint=function(a){var b=a[0],c=a[1],d=a[2];a=GMap.PlotUtils.getBisectorNormals(0,b,c,d)[0];d=GMap.PlotUtils.getNormal(b,c,d);if(Math.sqrt(d[0]*d[0]+d[1]*d[1])>GMap.Constants.ZERO_TOLERANCE){d=GMap.PlotUtils.mid(b,c);var e=b[0]-d[0],f=b[1]-d[1];c=2/GMap.PlotUtils.distance(b,c);b=-c*f;c*=e;e=2*b*c;f=a[0]-d[0];var h=a[1]-d[1];a=d[0]+(b*b-c*c)*f+e*h;d=d[1]+e*f+(c*c-b*b)*h}else a=b[0]+t*(c[0]-b[0]),d=b[1]+t*(c[1]-b[1]);return[a,d]};
GMap.PlotUtils.getRightMostControlPoint=function(a){var b=a.length,c=a[b-3],d=a[b-2];b=a[b-1];a=GMap.PlotUtils.getBisectorNormals(0,c,d,b)[1];c=GMap.PlotUtils.getNormal(c,d,b);if(Math.sqrt(c[0]*c[0]+c[1]*c[1])>GMap.Constants.ZERO_TOLERANCE){c=GMap.PlotUtils.mid(d,b);var e=b[0]-c[0],f=b[1]-c[1];b=2/GMap.PlotUtils.distance(d,b);d=-b*f;b*=e;e=2*d*b;f=a[0]-c[0];var h=a[1]-c[1];a=c[0]+(d*d-b*b)*f+e*h;c=c[1]+e*f+(b*b-d*d)*h}else a=b[0]+t*(d[0]-b[0]),c=b[1]+t*(d[1]-b[1]);return[a,c]};
GMap.PlotUtils.getBezierPoints=function(a){if(2>=a.length)return a;for(var b=[],c=a.length-1,d=0;1>=d;d+=.01){for(var e=y=0,f=0;f<=c;f++){var h=GMap.PlotUtils.getBinomialFactor(c,f),g=Math.pow(d,f),k=Math.pow(1-d,c-f);e+=h*g*k*a[f][0];y+=h*g*k*a[f][1]}b.push([e,y])}b.push(a[c]);return b};GMap.PlotUtils.getBinomialFactor=function(a,b){return GMap.PlotUtils.getFactorial(a)/(GMap.PlotUtils.getFactorial(b)*GMap.PlotUtils.getFactorial(a-b))};
GMap.PlotUtils.getFactorial=function(a){if(1>=a)return 1;if(2==a)return 2;if(3==a)return 6;if(4==a)return 24;if(5==a)return 120;for(var b=1,c=1;c<=a;c++)b*=c;return b};GMap.PlotUtils.getQBSplinePoints=function(a){if(2>=a.length)return a;var b=[],c=a.length-2-1;b.push(a[0]);for(var d=0;d<=c;d++)for(var e=0;1>=e;e+=.05){for(var f=y=0,h=0;2>=h;h++){var g=GMap.PlotUtils.getQuadricBSplineFactor(h,e);f+=g*a[d+h][0];y+=g*a[d+h][1]}b.push([f,y])}b.push(a[a.length-1]);return b};
...
d;else if("H"==c)a.extend([b.lat,d[0]]),b=new GMap.latLng(b.lat,d[0]);else if("V"==c)a.extend([d[0],b.lng]),b=new GMap.latLng(d[0],b.lng);else if("C"==c){var f=new GMap.latLng(d[0],d[1]);d=this._coords[++e];var h=new GMap.latLng(d[0],d[1]);d=this._coords[++e];d=new GMap.latLng(d[0],d[1]);a.extend(f);a.extend(h);a.extend(d);d.controlPoint1=f;d.controlPoint2=h;b=d}else if("S"==c){h=new GMap.latLng(d[0],d[1]);d=this._coords[++e];d=new GMap.latLng(d[0],d[1]);f=b;if(b.controlPoint2){f=b.lat-b.controlPoint2.lat;
var g=b.lng-b.controlPoint2.lng;f=new GMap.latLng(b.lat+f,b.lng+g)}a.extend(f);a.extend(h);a.extend(d);d.controlPoint1=f;d.controlPoint2=h;b=d}else"Q"==c?(h=new GMap.latLng(d[0],d[1]),d=this._coords[++e],d=new GMap.latLng(d[0],d[1]),a.extend(h),a.extend(d),d.controlPoint=h,b=d):"T"==c?(d=new GMap.latLng(d[0],d[1]),h=b,b.controlPoint&&(f=b.lat-b.controlPoint.lat,g=b.lng-b.controlPoint.lng,h=new GMap.latLng(b.lat+f,b.lng+g)),a.extend(h),a.extend(d),d.controlPoint=h,b=d):(a.extend(d),b=new GMap.latLng(d[0],
...
this._palette[a+1],this._palette[a+2]]},_drawOutline:function(a){var b,c;if(this._outlineWidth){var d=0;for(b=this._data.length;d<b;d++){var e=this._data[d];a.lineWidth=this._weight+2*this._outlineWidth;var f=1;for(c=e.length;f<c;f++){var h=e[f-1];var g=e[f];a.strokeStyle=this._outlineColor;a.beginPath();a.moveTo(h.x,h.y);a.lineTo(g.x,g.y);a.stroke()}}}},_drawHotline:function(a){var b,c;a.lineWidth=this._weight;var d=0;for(b=this._data.length;d<b;d++){var e=this._data[d];var f=1;for(c=e.length;f<
c;f++){var h=e[f-1];var g=e[f];var k=a.createLinearGradient(h.x,h.y,g.x,g.y);var l=this.getRGBForValue(h.z);var m=this.getRGBForValue(g.z);k.addColorStop(0,"rgb("+l.join(",")+")");k.addColorStop(1,"rgb("+m.join(",")+")");a.strokeStyle=k;a.beginPath();a.moveTo(h.x,h.y);a.lineTo(g.x,g.y);a.stroke()}}}};
...
_updateContent:function(){},_setPosition:function(a){var b=this._map,c=b.latLngToContainerPoint(b.getCenter()),d=b.layerPointToContainerPoint(a),e=this.options.direction,f=GLineLabelOverlay_toPoint(this.options.offset),h=this._getAnchor(),g=this._wrapper.offsetWidth,k=this._wrapper.offsetHeight,l=new GMap.Point(a.x,a.y);"top"===e||"TOP"===e?l=l.add(GLineLabelOverlay_toPoint(-g/2+f.x,-k+f.y+h.y,!0)):"bottom"===e||"BOTTOM"===e?l=l.subtract(GLineLabelOverlay_toPoint(g/2-f.x,-f.y,!0)):"center"===e||"CENTER"===
e?l=l.subtract(GLineLabelOverlay_toPoint(g/2+f.x,k/2-h.y+f.y,!0)):"right"===e||"auto"===e&&d.x<c.x?(e="right",l=l.add(GLineLabelOverlay_toPoint(f.x+h.x,h.y-k/2+f.y,!0))):(e="left",l=l.subtract(GLineLabelOverlay_toPoint(g+h.x-f.x,k/2-h.y-f.y,!0)));new GMap.Point(a.x,a.y);d=this._container.childNodes[0].offsetHeight;c=this._container.childNodes[0].offsetWidth;null===this.options.offset?new GMap.Point(a.x,a.y):new GMap.Point(a.x+this.options.lineOffset.x,a.y-this.options.lineOffset.y-d);1==this._map.g_adjustWithMap&&
(f=this._map.g_adjustArray[this._map.getZoom()],null==f&&(f=[100,100]),"bottom"!=e&&"BOTTOM"!=e&&(l.y=l.y+f[1]/2+10));GMap.DomUtil.setPosition(this._wrapper,l);this.options.showLineLabel&&(null==this._poly&&(this._poly=new GMap.GWenziLine([],this.options.shapeOptions),this._map.addLayer(this._poly),this._poly.setTextContainer2(this)),e=new GMap.Point(a.x+1*this.options.lineOffset.x-3,a.y-1*this.options.lineOffset.y),l=this._map.layerPointToLatLng(e),b=[],
...
b.y);a.setAttribute("width",b.width);a.setAttribute("height",b.height);a.setAttribute("patternUnits",b.patternUnits);a.setAttribute("patternContentUnits",b.patternContentUnits);if(b.patternTransform||b.angle){var c=b.patternTransform?b.patternTransform+" ":"";c+=b.angle?"rotate("+b.angle+") ":"";a.setAttribute("patternTransform",c)}else a.removeAttribute("patternTransform");for(var h in this._shapes)this._shapes[h]._updateStyle()}}});GMap.Map.include({_initDefRoot:function(){if(!this._defRoot)if("function"===
...
"deg)")}},setRotationAngle:function(a){this.options.rotationAngle=a;this.update();return this},setRotationOrigin:function(a){this.options.rotationOrigin=a;this.update();return this}});GMap.LineTextOverlay=GMap.Layer.extend({initialize:function(a,b,c,h){this._latlng2=this._latlng=a;this._angle=b;this._distance=c;GMap.Util.setOptions(this,h);this._visible=!0},options:{offset:null,cssClass:"label-overlay",annoText:""},computeDesitination:function(a,b,c,h){var d=Math.PI/180,e=6378137*(1-.003352810664/
3),f=Math.asin(Math.sin(a*d)*Math.cos(h/e)+Math.cos(a*d)*Math.sin(h/e)*Math.cos(c*d))/d;return new GMap.LatLng(f,b+Math.atan2(Math.sin(c*d)*Math.sin(h/e)*Math.cos(a*d),Math.cos(h/e)-Math.sin(a*d)*Math.sin(f*d))/d)},computeTrueCourse:function(a,b,c,h){var d=Math.PI/180;return(Math.atan2(Math.sin((h-b)*d)*Math.cos(c*d),Math.cos(a*d)*Math.sin(c*d)-Math.sin(a*d)*Math.cos(c*d)*Math.cos((h-b)*d))/d+360)%360},onAdd:function(a){this._map=a;if(this._angle||0<this._distance){var b=this._latlng.lat,d=this._latlng.lng,
c=Math.PI/180,g=this._distance/6371E3/c,k=a.project([b+g,d]),l=a.project([b-g,d]);k=k.add(l).divideBy(2);l=a.unproject(k).lat;var m=Math.acos((Math.cos(g*c)-Math.sin(b*c)*Math.sin(l*c))/(Math.cos(b*c)*Math.cos(l*c)))/c;if(isNaN(m)||0===m)m=g/Math.cos(Math.PI/180*b);b=isNaN(m)?0:k.x-a.project([l,d-m]).x;this.options.offset={};this.options.offset.x=b*Math.sin(this._angle*c);this.options.offset.y=b*Math.cos(this._angle*c);c=this._map.latLngToLayerPoint(this._latlng);b=new GMap.Point(c.x+this.options.offset.x,
...
a.on("viewreset",this._reset,this);a.on("zoomend",this._reset,this);if(a.options.zoomAnimation&&a.options.markerZoomAnimation)a.on("zoomanim",this._animateZoom,this);this._reset()},_animateZoom:function(a){a=this._map._latLngToNewLayerPoint(this._latlng,a.zoom,a.center);a=null===this.options.offset?new GMap.Point(a.x,a.y):new GMap.Point(a.x+this.options.offset.x,a.y-this.options.offset.y);GMap.DomUtil.setPosition(this._container,a)},onRemove:function(a){for(var b=this._container.childNodes,c=b.length-
1;0<=c;c--)this._container.removeChild(b[c]);a.getPanes().overlayPane.removeChild(this._container);null!=this._poly&&(a.removeLayer(this._poly),delete this._poly);a.off("viewreset",this._reset,this);a.off("zoomend",this._reset,this);a.off("zoomanim",this._animateZoom,this)},_reset:function(){var a=this._map.latLngToLayerPoint(this._latlng),b=this._map.latLngToLayerPoint(this._latlng2);this._setPos(a,b)},_setPos:function(a,b){new GMap.Point(a.x,a.y);var c=this._container.childNodes[0].offsetHeight,
d=this._container.childNodes[0].offsetWidth;var e=new GMap.Point(b.x,b.y-c);b.x<a.x&&(e=new GMap.Point(b.x-d,b.y-c));GMap.DomUtil.setPosition(this._container,e);null!=this._poly&&(e=new GMap.Point(b.x+d,b.y),b.x<a.x&&(e=new GMap.Point(b.x-d,b.y)),a=this._map.layerPointToLatLng(e),b=[],b.push(this._latlng),b.push(this._latlng2),b.push(a),this._poly._setControlLatLngs(b),this._poly._plotExisting())},_initLayout:function(){var a=document.createElement("div"),b=document.createElement("span");a.className=
...
GMap.Canvas.include({_updatePolycol:function(a,b){if(this._drawing){var c,d,e=a._parts,f=e.length,h=this._ctx;if(f){h.beginPath();for(c=0;c<f;c++){var g=0;for(d=e[c].length;g<d;g++){var k=e[c][g];h[g?"lineTo":"moveTo"](k.x,k.y)}b&&h.closePath()}this._fillStrokePolycol(h,a)}}},_fillStrokePolycol:function(a,b){for(var c=b.options,d={r:255,g:0,b:0,a:255},e=c.bgFillColor,f=[],h=1;7>h;h+=2)f.push(parseInt("0x"+e.slice(h,h+2)));d.r=f[0];d.g=f[1];d.b=f[2];e=createImageData(8,8);if("fillByXieline"==c.fillType)for(h=
0;8>h;h++)for(f=0;8>f;f++)h==7-f&&setPixel(e,d,h,f);else if("fillByAntixieline"==c.fillType)for(h=0;8>h;h++)for(f=0;8>f;f++)h==f&&setPixel(e,d,h,f);else if("fillByJinline"==c.fillType)for(h=0;8>h;h++)for(f=0;8>f;f++)4!=h&&4!=f||setPixel(e,d,h,f);else if("fillByHline"==c.fillType)for(h=0;8>h;h++)for(f=0;8>f;f++)4==f&&setPixel(e,d,h,f);else if("fillByVline"==c.fillType)for(h=0;8>h;h++)for(f=0;8>f;f++)4==h&&setPixel(e,d,h,f);"fillByColor"==c.fillType?a.fillStyle=c.bgFillColor:(d=imageDataToCanvas(e),
d=a.createPattern(d,"repeat"),a.fillStyle=d);a.fill();c.stroke&&0!==c.weight&&(a.setLineDash&&a.setLineDash(b.options&&b.options._dashArray||[]),a.globalAlpha=c.opacity,a.lineWidth=c.weight,a.strokeStyle=c.color,a.lineCap=c.lineCap,a.lineJoin=c.lineJoin,a.stroke())},_polycol:function(a,b,c){var d=b._pxBounds||this.__polycolBounds;this.__polycolBounds=d;this.__polycolFillData=c=c||this.__polycolFillData;var e=this.__clamp(c.padding,0,100)||1,f=c.noDataColor||"rgb(50,50,50)",h=c.orientation||"vertical";
e=.1*e/100;var g=(d.max.x-d.min.x)/2,k=(d.max.y-d.min.y)/2;d="horizontal"==h?a.createLinearGradient(d.min.x,d.min.y+k,d.max.x,d.max.y-k):a.createLinearGradient(d.min.x+g,d.min.y,d.max.x-g,d.max.y);h=0;for(g=0;g<c.data.length;g++){k=Object.keys(c.data[g])[0];var l=Object.values(c.data[g])[0];l=parseFloat((l/100).toFixed(2))-e;l=this.__clamp(l,0,1);h=this.__clamp(h,0,1);l=this.__clamp(h+l,0,1);d.addColorStop(h,k);d.addColorStop(l,k);h=l+e}1>h&&(d.addColorStop(h,f),d.addColorStop(1,f));a.fillStyle=d;
a.fill(b.options.fillRule)},__clamp:function(a,b,c){return Math.min(Math.max(a,b),c)}});function getSqDist(a,b){var c=a.x-b.x;a=a.y-b.y;return c*c+a*a}function getSqSegDist(a,b,c){var d=b.x;b=b.y;var e=c.x-d,f=c.y-b;if(0!==e||0!==f){var h=((a.x-d)*e+(a.y-b)*f)/(e*e+f*f);1<h?(d=c.x,b=c.y):0<h&&(d+=e*h,b+=f*h)}e=a.x-d;f=a.y-b;return e*e+f*f}function simplifyRadialDist(a,b){for(var c=a[0],d=[c],e,f=1,h=a.length;f<h;f++)e=a[f],getSqDist(e,c)>b&&(d.push(e),c=e);c!==e&&d.push(e);return d}
function simplifyDPStep(a,b,c,d,e){for(var f=d,h,g=b+1;g<c;g++){var k=getSqSegDist(a[g],a[b],a[c]);k>f&&(h=g,f=k)}f>d&&(1<h-b&&simplifyDPStep(a,b,h,d,e),e.push(a[h]),1<c-h&&simplifyDPStep(a,h,c,d,e))}function simplifyDouglasPeucker(a,b){var c=a.length-1,d=[a[0]];simplifyDPStep(a,0,c,b,d);d.push(a[c]);return d}function simplify(a,b,c){if(2>=a.length)return a;b=void 0!==b?b*b:1;a=c?a:simplifyRadialDist(a,b);return a=simplifyDouglasPeucker(a,b)};
