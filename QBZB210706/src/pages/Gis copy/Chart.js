        ...
        <div className={styles.body}>
          ...
          <div className={styles.text}>
            {typeof maxIndex === "number" && (
              <div>
                <span className={styles.blueCircle} /> 最高点A (
                {maxCoords[0].toFixed(2)}
                °,
                {maxCoords[1].toFixed(2)}
                °): {xData[maxIndex]} km
              </div>
            )}
            {typeof minIndex === "number" && (
              <div>
                <span className={styles.blueCircle} /> 最低点B (
                {minCoords[0].toFixed(2)}
                °,
                {minCoords[1].toFixed(2)}
                °): {xData[minIndex]} km
              </div>
            )}
